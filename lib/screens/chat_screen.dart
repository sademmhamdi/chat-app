...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _showAttachmentOptions(ChatService chatService, AuthService authService) {
  ...
  void _pickImage(ImageSource source, ChatService chatService, AuthService authService) async {
