...
class RockPaperScissorsGame extends StatefulWidget {
  ...
  const RockPaperScissorsGame({Key? key, required this.chatRoomId})
      : super(key: key);
...
class _RockPaperScissorsGameState extends State<RockPaperScissorsGame> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Icon(choiceIcons[computerChoice]!,
  ...
  void _shareResult() {
    ...
    String shareText =
        'Rock Paper Scissors - Score: You $playerScore - Computer $computerScore';
...
class _NumberGuessGameState extends State<NumberGuessGame> {
  ...
  void _shareResult() {
    ...
    String result =
        'Number Guess Game: Guessed $targetNumber in $attempts attempts!';
