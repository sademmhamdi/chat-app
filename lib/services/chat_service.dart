...
class ChatService extends ChangeNotifier {
  ...
  Future<String> createDirectChat(String currentUserId, String otherUserId) async {
  ...
  Future<String> createGroupChat(String name, List<String> participants, String createdBy) async {
